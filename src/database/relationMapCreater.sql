...
CREATE TABLE subjects_labels
(
	id int unsigned NOT NULL UNIQUE COMMENT '主体_タグ連携id',
	-- モノID
	subject_id int unsigned NOT NULL COMMENT '主体id : モノID',
	-- タグID
	label_id int unsigned NOT NULL COMMENT 'ラベルid : タグID',
	...
	modified datetime COMMENT '変更日時 : 変更日時',
	PRIMARY KEY (id)
) ENGINE = InnoDB COMMENT = '主体_ラベル連携テーブル' DEFAULT CHARACTER SET utf8;
